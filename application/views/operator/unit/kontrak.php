                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="text-align: center">
                                                ...
                                                <td style="color: black"><?= date('d F Y', strtotime($user->tgl_join)) ?></td>
                                                <td style="color: black"><?php
                                                    $tgl1 = date('d F Y', strtotime($user->tgl_join));// pendefinisian tanggal awal
                                                    $tgl2 = date('d F Y', strtotime('+3 months', strtotime($tgl1))); //operasi penjumlahan tanggal sebanyak Bulan

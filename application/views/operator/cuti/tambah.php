<div class="content-body" style="margin-bottom: -420px">
    <div class="container-fluid">
        ...
        <?php
        echo form_open_multipart(base_url('Operator/Cuti/add/'.$karyawan->id_karyawan));
         ?>
        <div class="card">
        	<div class="card-body">
        		<div class="row">
                      ...
                      <div class="form-group row">
                        <label class="col-md-2 col-form-label" style="color: black">Tanggal Awal</label>
                         <div class="col-md-10 p-0 text-center">
                         	 <input type="date" class="form-control" name="tgl_awal" value="<?php echo set_value('tgl_awal')?>">
                         </div>
                      </div>
                      ...
                      <div class="form-group row">
                        <label class="col-md-2 col-form-label" style="color: black">Tanggal Akhir</label>
                         <div class="col-md-10 p-0 text-center">
                         	 <input type="date" class="form-control" name="tgl_akhir" value="<?php echo set_value('tgl_akhir')?>">
                         </div>
                      </div>
                      ...
                      <div class="form-group row">
                        <label class="col-md-2 col-form-label" style="color: black">Jumlah Hari</label>
                         <div class="col-md-10 p-0 text-center">
                         	 <input type="text" class="form-control" name="jml_hari" value="<?php echo set_value('jml_hari')?>">
                         </div>
                      </div>

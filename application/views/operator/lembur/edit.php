<div class="content-body" style="margin-bottom: -420px">
    <div class="container-fluid">
        ...
        <?php
        echo form_open_multipart(base_url('Operator/Lembur/edit/'.$lembur->id_lembur));
         ?>
        <div class="card">
        	<div class="card-body">
        		 <div class="row">
                    <div class="col-md-12">
                      <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                               <input type="date" class="form-control" name="tanggal" value="<?php echo $lembur->tanggal ?>">
                            </div>
                          </div>
                           <div class="col-md-2">
                            <div class="form-group">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                                <select name="waktu" class="form-control">
                                  ...
                                  <option value="Hari Biasa" <?php if($lembur->waktu=="Hari Biasa"){echo 'selected';}?>>Hari Biasa</option>
                                  <option value="Hari Minggu" <?php if($lembur->waktu=="Hari Minggu"){echo 'selected';}?>>Hari Minggu</option>
                                  <option value="Hari Libur" <?php if($lembur->waktu=="Hari Libur"){echo 'selected';}?>>Hari Libur</option>
                                </select>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                               <input type="time" class="form-control" name="jam_awal" value="<?php echo $lembur->jam_awal ?>">
                            </div>
                          </div>
                           <div class="col-md-2">
                            <div class="form-group">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                               <input type="time" class="form-control" name="jam_akhir" value="<?php echo $lembur->jam_akhir ?>">
                            </div>
                          </div>
                        </div>

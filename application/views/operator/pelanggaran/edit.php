              ...
              <div class="col-md-12">
                ...
                <div class="form-group row">
                  <label class="col-md-2 col-form-label" style="color: black">No Surat</label>
                    <div class="col-md-10 p-0 text-center">
                      <input type="text" class="form-control" name="no_surat" value="<?php echo $pelanggaran->no_surat?>" placeholder=".../60/SPIII/HRD/SHI/.../20">
                    </div>
                </div>
                <div class="form-group row">
                  ...
                  <label class="col-md-2 col-form-label" style="color: black">Sanksi</label>
                    <div class="col-md-10 p-0 text-center">
                      <select name="sanksi" class="form-control" id="single-select">
                          ...
                          <option value="STT1" <?php if($pelanggaran->sanksi=="STT1"){echo 'selected';}?> style="color: black">STT 1</option>
                          <option value="STT2" <?php if($pelanggaran->sanksi=="STT2"){echo 'selected';}?> style="color: black">STT 1</option>
                          <option value="STT3" <?php if($pelanggaran->sanksi=="STT3"){echo 'selected';}?> style="color: black">STT 1</option>
                          <option value="SP1" <?php if($pelanggaran->sanksi=="SP1"){echo 'selected';}?> style="color: black">SP 1</option>
                          <option value="SP2" <?php if($pelanggaran->sanksi=="SP2"){echo 'selected';}?> style="color: black">SP 2</option>
                          <option value="SP3" <?php if($pelanggaran->sanksi=="SP3"){echo 'selected';}?> style="color: black">SP 3</option>
                          <option value="Skorsing" <?php if($pelanggaran->sanksi=="Skorsing"){echo 'selected';}?> style="color: black">Skorsing</option>
                          <option value="Tertulis" <?php if($pelanggaran->sanksi=="Tertulis"){echo 'selected';}?> style="color: black">Tertulis</option>
                      </select>
                    </div>
                </div>
